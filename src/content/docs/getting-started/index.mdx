...
The [GitHub Workflows](https://github.com/saucer/saucer/actions/workflows/ci.yml) automatically produce a pre-built artifact for Windows that you can link against manually.
